DROP TABLE IF EXISTS CASCADE Customer, Authentication, DataScientist, Admin, Interaction , Dataset, ABTest, Users, Item;
DROP TABLE IF EXISTS CASCADE Recommendation, Algorithm;
